...
#define _nstates19	128	/* fairness */
#define minseq19	17805
#define maxseq19	17931
#define _endstate19	127

#define _nstates18	188	/* liveness */
#define minseq18	17618
#define maxseq18	17804
#define _endstate18	187

#define _nstates17	14	/* supervisor_halts_last */
#define minseq17	17605
#define maxseq17	17617
#define _endstate17	13

#define _nstates16	11	/* supervisor_never_aborts */
#define minseq16	17595
#define maxseq16	17604
#define _endstate16	10

#define _nstates15	23	/* supervisor_stops_after_some_workers_abort */
#define minseq15	17573
#define maxseq15	17594
#define _endstate15	22

#define _nstates14	23	/* supervisor_stops_after_all_workers_stop */
#define minseq14	17551
#define maxseq14	17572
#define _endstate14	22

#define _nstates13	11	/* supervisor_constructs_workers */
#define minseq13	17541
#define maxseq13	17550
#define _endstate13	10

#define _nstates12	11	/* supervisor_is_the_first_thread */
#define minseq12	17531
#define maxseq12	17540
#define _endstate12	10

#define _nstates11	503	/* abort_is_undoable */
#define minseq11	17029
#define maxseq11	17530
#define _endstate11	502

#define _nstates10	503	/* fsm_aborted */
#define minseq10	16527
#define maxseq10	17028
#define _endstate10	502

#define _nstates9	41	/* fsm_aborting */
#define minseq9	16487
#define maxseq9	16526
#define _endstate9	40

#define _nstates8	503	/* fsm_stopped */
#define minseq8	15985
#define maxseq8	16486
#define _endstate8	502

#define _nstates7	41	/* fsm_stopping */
#define minseq7	15945
#define maxseq7	15984
#define _endstate7	40

#define _nstates6	137	/* fsm_paused */
#define minseq6	15809
#define maxseq6	15944
#define _endstate6	136

#define _nstates5	137	/* fsm_running */
#define minseq5	15673
#define maxseq5	15808
#define _endstate5	136

#define _nstates4	41	/* fsm_starting */
#define minseq4	15633
#define maxseq4	15672
#define _endstate4	40

#define _nstates3	333	/* fsm_ready */
#define minseq3	15301
#define maxseq3	15632
#define _endstate3	332

#define _nstates2	373	/* :init: */
#define minseq2	14929
#define maxseq2	15300
#define _endstate2	372

#define _nstates1	14622	/* Supervisor */
#define minseq1	308
#define maxseq1	14928
#define _endstate1	14621

#define _nstates0	309	/* Thread */
#define minseq0	0
#define maxseq0	307
#define _endstate0	308
...
typedef struct P19 { /* fairness */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P17 { /* supervisor_halts_last */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P16 { /* supervisor_never_aborts */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P15 { /* supervisor_stops_after_some_workers_abort */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P14 { /* supervisor_stops_after_all_workers_stop */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P13 { /* supervisor_constructs_workers */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P12 { /* supervisor_is_the_first_thread */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P11 { /* abort_is_undoable */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P10 { /* fsm_aborted */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P9 { /* fsm_aborting */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P7 { /* fsm_stopping */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* fsm_starting */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
#define PSupervisor	((P1 *)_this)
typedef struct P1 { /* Supervisor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, k) - 1*sizeof(uchar))

typedef struct P20 { /* np_ */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 6; /* proctype */
	unsigned _p   : 15; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P21 {
	...
	unsigned _p   : 15; /* active-claim state */
...
#endif
	uchar executing[3];
	unsigned serialize_commands : 1;
	unsigned all_workers_stopped : 1;
	unsigned exists_aborted_worker : 1;
	unsigned supervisor_started : 1;
	uchar states[3];
	uchar commands[3];
#ifdef TRIX
...
#define _NP_	20
#define _nstates20	3 /* np_ */
#define _endstate20	2 /* np_ */

#define _start20	0 /* np_ */
#define _start19	19
#define _start18	23
#define _start17	5
#define _start16	6
...
#else
	#define ACCEPT_LAB	102 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
