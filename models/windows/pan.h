...
#define _nstates1	18	/* Source */
#define minseq1	64
#define maxseq1	80
#define _endstate1	17

#define _nstates0	65	/* p5 */
#define minseq0	0
#define maxseq0	63
...
#define PSource	((P1 *)_this)
typedef struct P1 { /* Source */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, ball) - 1*sizeof(uchar))
