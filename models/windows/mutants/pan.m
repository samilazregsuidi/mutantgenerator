...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* CLAIM never_0 */
	case 3: // STATE 1 - mutant_37.pml.nvr:5 - [((!((rcvd==red))&&(sent==red)))] (0:0:0 - 1)
...
#endif
		reached[2][1] = 1;
		if (!(( !((now.rcvd==1))&&(now.sent==1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 8 - mutant_37.pml.nvr:10 - [(!((rcvd==red)))] (0:0:0 - 1)
		...
		if (!( !((now.rcvd==1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 13 - mutant_37.pml.nvr:12 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Source */
	case 6: // STATE 1 - mutant_37.pml:81 - [source!white] (0:0:0 - 1)
		IfNotBlocked
		reached[1][1] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 7: // STATE 2 - mutant_37.pml:82 - [source!red] (0:0:0 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		if (q_full(now.source))
			continue;
		...
		if (q_zero(now.source)) { boq = now.source; };
		_m = 2; goto P999; /* 0 */
	case 8: // STATE 7 - mutant_37.pml:86 - [source!white] (0:0:0 - 1)
		IfNotBlocked
		reached[1][7] = 1;
		if (q_full(now.source))
			continue;
		...
		if (q_zero(now.source)) { boq = now.source; };
		_m = 2; goto P999; /* 0 */
	case 9: // STATE 8 - mutant_37.pml:87 - [source!blue] (0:0:0 - 1)
		IfNotBlocked
		reached[1][8] = 1;
		if (q_full(now.source))
			continue;
		...
		if (q_zero(now.source)) { boq = now.source; };
		_m = 2; goto P999; /* 0 */
	case 10: // STATE 13 - mutant_37.pml:92 - [source!white] (0:0:0 - 1)
		IfNotBlocked
		reached[1][13] = 1;
		if (q_full(now.source))
			continue;
		...
		if (q_zero(now.source)) { boq = now.source; };
		_m = 2; goto P999; /* 0 */
	case 11: // STATE 17 - mutant_37.pml:94 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][17] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC p5 */
	case 12: // STATE 3 - mutant_37.pml:12 - [D_STEP12]
		IfNotBlocked
...
S_061_0: /* 1 */
	...
	case 13: // STATE 4 - mutant_37.pml:18 - [((nbuf<3))] (9:0:1 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 14: // STATE 6 - mutant_37.pml:21 - [((_pid%2))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][6] = 1;
		if (!((((int)((P0 *)_this)->_pid)%2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 7 - mutant_37.pml:22 - [source?ball] (12:0:2 - 1)
		reached[0][7] = 1;
		...
		;
		_m = 4; goto P999; /* 2 */
	case 16: // STATE 11 - mutant_37.pml:25 - [frames[NextFrame] = ball] (0:12:1 - 3)
		IfNotBlocked
		reached[0][11] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 12 - mutant_37.pml:26 - [out!ball,NextFrame,((FrameExp+3)%(3+1))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 18: // STATE 13 - mutant_37.pml:28 - [((_pid%2))] (61:0:2 - 1)
		IfNotBlocked
		reached[0][13] = 1;
		if (!((((int)((P0 *)_this)->_pid)%2)))
			continue;
		...
		reached[0][14] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		(trpt+1)->bup.ovals[0] = now.sent;
		now.sent = ((P0 *)_this)->ball;
#ifdef VAR_RANGES
		logval("sent", now.sent);
#endif
		;
		/* merge: .(goto)(61, 17, 61) */
		reached[0][17] = 1;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 19: // STATE 17 - mutant_37.pml:32 - [.(goto)] (0:61:1 - 2)
		IfNotBlocked
		reached[0][17] = 1;
		;
		/* merge: NextFrame = ((NextFrame+1)%(3+1))(61, 18, 61) */
		...
		;
		_m = 3; goto P999; /* 2 */
	case 20: // STATE 20 - mutant_37.pml:35 - [in?ball,r,s] (0:0:3 - 1)
		reached[0][20] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 21: // STATE 21 - mutant_37.pml:37 - [((r==FrameExp))] (0:0:1 - 1)
		IfNotBlocked
		reached[0][21] = 1;
		...
		if (!readtrail)
			...
			((P0 *)_this)->r = 0;
		_m = 3; goto P999; /* 0 */
	case 22: // STATE 22 - mutant_37.pml:39 - [((_pid%2))] (41:0:1 - 1)
		IfNotBlocked
		reached[0][22] = 1;
		if (!((((int)((P0 *)_this)->_pid)%2)))
			continue;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 23: // STATE 24 - mutant_37.pml:41 - [rcvd = ball] (0:41:2 - 1)
		IfNotBlocked
		reached[0][24] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		...
		;
		_m = 3; goto P999; /* 3 */
	case 24: // STATE 27 - mutant_37.pml:43 - [FrameExp = ((FrameExp+1)%(3+1))] (0:41:1 - 3)
		IfNotBlocked
		reached[0][27] = 1;
		(trpt+1)->bup.oval = ((int)((P0 *)_this)->FrameExp);
		((P0 *)_this)->FrameExp = ((((int)((P0 *)_this)->FrameExp)+1)%(3+1));
		...
		;
		_m = 3; goto P999; /* 1 */
	case 25: // STATE 30 - mutant_37.pml:46 - [.(goto)] (0:41:0 - 2)
		IfNotBlocked
		reached[0][30] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 26: // STATE 41 - mutant_37.pml:47 - [D_STEP47]
...
S_039_0: /* 2 */
	...
	case 27: // STATE 42 - mutant_37.pml:57 - [(timeout)] (0:0:0 - 1)
		IfNotBlocked
		reached[0][42] = 1;
		if (!(((trpt->tau)&1)))
			continue;
		_m = 1; goto P999; /* 0 */
	case 28: // STATE 60 - mutant_37.pml:58 - [D_STEP58]
		IfNotBlocked
...
S_058_0: /* 2 */
	...
	case 29: // STATE 64 - mutant_37.pml:77 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][64] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
