...
#define _nstates2	55	/* never_0 */
#define minseq2	161
#define maxseq2	214
#define _endstate2	54

#define _nstates1	121	/* controller */
#define minseq1	41
#define maxseq1	160
#define _endstate1	120

#define _nstates0	42	/* ptPersonDetermined */
#define minseq0	0
#define maxseq0	40
...
struct features { /* user defined type */
	unsigned TTFull : 1;
	unsigned Shuttle : 1;
	unsigned QuickClose : 1;
	unsigned Park : 1;
	unsigned Overload : 1;
	unsigned OpenIfIdle : 1;
	unsigned Exec : 1;
	unsigned Empty : 1;
	unsigned Elevator : 1;
};
struct tPerson { /* user defined type */
	unsigned in_elevator : 1;
	uchar to_floor;
	uchar at_floor;
};
struct tButton { /* user defined type */
	unsigned pushed : 1;
};
...
#define PptPersonDetermined	((P0 *)_this)
typedef struct P0 { /* ptPersonDetermined */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	uchar direction;
	struct features f;
	struct tPerson person[2];
	struct tButton cabin_button[4];
	struct tButton floor_button[4];
#ifdef TRIX
