...
public:
	...
	* * * * * * * * * * * * * * * * * * * * * * * */
	...
	astNode(Type type, const std::string& sVal, int iVal, astNode* child0, astNode* child1, astNode* child2, int lineNb, const fsm* fsmChild = nullptr, symTabNode* symTabChild = nullptr);
	virtual ~astNode();
	...
	virtual fsm* toFsm(fsm* fsmVal, const symTabNode* symTab) const;
...
protected:
	stmnt(Type type, const std::string& sVal, int iVal, astNode* child0, astNode* child1, astNode* child2, int lineNb, const fsm* fsmChild = nullptr, symTabNode* symTabChild = nullptr)
...
public:
	...
	fsm* toFsm(fsm* fsmVal, const symTabNode* symTab) const {
		return child[0]->toFsm(fsmVal, symTab);
	}
...
protected:
	expr(Type type, const std::string& sVal, int iVal, astNode* child0, astNode* child1, astNode* child2, int lineNb, const fsm* fsmChild = nullptr, symTabNode* symTabChild = nullptr)
		: astNode(type, sVal, iVal, child0, child1, child2, lineNb, fsmChild, symTabChild)
	{}
};
...
public:
	...
	void resolveVariables(symTabNode* global, const mTypeNode* mTypes, symTabNode* local, symTabNode* subField = nullptr) {
		...
		if(symTab && child[0]) {
			...
			int mvar = 0;
			if(mvar == 0 && sVal == MVARID_LAST) mvar = MVAR_LAST;
			if(mvar == 0 && sVal == MVARID_NRPR) mvar = MVAR_NRPR;
			if(mvar == 0 && sVal == MVARID_PID) mvar = MVAR_PID;
			if(mvar == 0 && sVal == MVARID_SCRATCH) mvar = MVAR_SCRATCH;
...
protected:
	exprBinary(Type type, const std::string& sVal, int iVal, astNode* child0, astNode* child1, astNode* child2, int lineNb, const fsm* fsmChild = nullptr, symTabNode* symTabChild = nullptr)
...
protected:
	exprUnary(Type type, const std::string& sVal, int iVal, astNode* child0, astNode* child1, astNode* child2, int lineNb, const fsm* fsmChild = nullptr, symTabNode* symTabChild = nullptr)
		: expr(type, sVal, iVal, child0, child1, child2, lineNb, fsmChild, symTabChild)
	{}
...
protected:
	exprRArg(Type type, const std::string& sVal, int iVal, astNode* child0, astNode* child1, astNode* child2, int lineNb, const fsm* fsmChild = nullptr, symTabNode* symTabChild = nullptr)
		: expr(type, sVal, iVal, child0, child1, child2, lineNb, fsmChild, symTabChild)
	{}
};
